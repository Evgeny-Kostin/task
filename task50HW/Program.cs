...
// Добрый день! В 50 задаче вы задаёте два массива: numbers из 10 строк и 10 столбцов и он пустой, 
// заполнен только 0, а второй массив array вы заполняете с учётом ввода строк и 
// столбцов от пользователя. Поэтому когда вы вводите значения меньше, чем 10x10 он вам 0 и выдает. 
// Вам сравнение нужно делать с заполненным массивом, а не пустым. Пустой массив вам вообще не нужен 
// в этой задаче.
// В целом хорошо справились с задачами!
