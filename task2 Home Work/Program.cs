...
//Обратите внимание, в переменной max и min уже по умолчанию присвоены значения A и B, 
// поэтому достаточно сделать лишь одну проверку и если окажется, 
// что A < B мы просто перезапишем значения, если нет значит всё верно и так оставим!
//В 4 задаче можно удалить ветку с проверкой numberA, 
// так как оно лежит по умолчанию уже в переменной max.
